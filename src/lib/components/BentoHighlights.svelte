...
{#if $viewMode === 'focused'}
	<div class="grid gap-4 md:grid-cols-6">
		...
		<article class="hand-card hand-tilt-c p-5 sm:p-6 md:col-span-2">
		...
		<article class="hand-card hand-tilt-a p-5 sm:p-6 md:col-span-2">
		...
		<article class="hand-card hand-tilt-b p-5 sm:p-6 md:col-span-2">
...
{:else}
	<div class="highlights-stack">
		...
		<div class="notes-grid">
			<article class="hand-card hand-tilt-a note-panel">
			...
			<article class="hand-card hand-tilt-c note-panel">
				<div class="panel-heading">
					<h3>Toolbox</h3>
